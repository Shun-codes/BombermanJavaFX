 ...
 * @version 0.1.0
 * 
 * Monsieur Wallon nous a donnée le début des classe Application et les classes BOMB 
 */
...
public class BombermanApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("view/Bomberman-view.fxml"));
        ...
        controller.setBombermanGame(bombermanGame);
        bombermanGame.setInterfaceBomberman(controller);
        bombermanGame.initMap(HEIGTH, WIDTH);
