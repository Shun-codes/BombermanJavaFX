...
public enum TileContent {
    ...
    /**
     * Le contenu d'une tuile comportant un mur de pierre (thème niveau 2), qui peut être
     * détruit par une explosion.
     */
    LVL2_WALL("caisselvl2", false, true),
    
    /**
     * Le contenu d'une tuile comportant un mur de bois (thème niveau 3), qui peut être
     * détruit par une explosion.
     */
    LVL3_WALL("caisselvl3", false, true),
    
    /**
     * Le contenu d'une tuile comportant un mur de métal (thème niveau 4), qui peut être
     * détruit par une explosion.
     */
    LVL4_WALL("caisselvl4", false, true),
    
    /**
     * Le contenu d'une tuile comportant un mur de cristal (thème niveau 5), qui peut être
     * détruit par une explosion.
     */
    LVL5_WALL("caisselvl5", false, true),

    /**
     * Le contenu d'une tuile comportant un mur de pierre solide, qui ne peut pas être
     * détruit par une explosion.
     */
    SOLID_WALL("wall", false, false),
    
    /**
     * Le contenu d'une tuile comportant un mur de pierre solide alternatif, qui ne peut pas être
     * détruit par une explosion.
     */
    SOLID_WALL2("wall2", false, false);
